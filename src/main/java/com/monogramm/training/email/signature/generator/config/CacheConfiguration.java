package com.monogramm.training.email.signature.generator.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.monogramm.training.email.signature.generator.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.monogramm.training.email.signature.generator.repository.UserRepository.USERS_BY_EMAIL_CACHE);
